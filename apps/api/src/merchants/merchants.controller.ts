...
export class MerchantsController {
  ...
  async findById(
    ...
    return this.merchants.findById(id, user.userId);
  }
  ...
  async update(
    ...
    return this.merchants.update(id, dto, user.userId);
  }
  ...
  async createBranch(
    ...
    return this.merchants.createBranch(merchantId, dto, user.userId);
  }
  ...
  async listBranches(
    ...
    return this.merchants.listBranches(merchantId, user.userId);
  }
  ...
  async createUser(
    ...
    return this.merchants.createUser(merchantId, dto, user.userId);
  }
  ...
  async listUsers(
    ...
    return this.merchants.listUsers(merchantId, user.userId);
  }
